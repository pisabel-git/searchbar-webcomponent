...
import SearchbarComponent from './direflow-components/searchbar-component';

SearchbarComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('searchbar-component is mounted on the DOM', element);
});
